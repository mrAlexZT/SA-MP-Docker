...
yum install mc git wget tar bash-completion vsftpd net-tools tcpdump telnet supervisor \ 
make cmake gcc gcc-c++ libstdc++-devel \ 
compat-libstdc++-33.i686 libstdc++.i686 libstdc++-devel.i686 glibc-devel.i686 -y
