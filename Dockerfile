...
RUN yum install mc git wget tar vsftpd net-tools tcpdump gcc gcc-c++ make cmake libstdc++-devel compat-libstdc++-33.i686 libstdc++.i686 libstdc++-devel.i686 bash-completion -y
